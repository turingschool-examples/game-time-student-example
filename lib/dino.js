...
class Dino extends Block {
  ...
  // Refactor bottomRight, bottomMiddle, bottomLeft into one line functions
  get bottomRight() {
    return {x: this.x + (this.width * 0.92), y: this.y + (this.height * 0.98)};
  }
  ...
  get bottomLeft() {
    return {x: this.x, y: this.y + (this.height * 0.96)};
  }
