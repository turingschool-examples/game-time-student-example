...
// Refactor bottomDinoHit to one function instead of three
  dinoHitCactus() {
    return this.bottomDinoHit(this.dino.bottomLeft.x,this.dino.bottomLeft.y) ||
           this.bottomDinoHit(this.dino.bottomMiddle.x,this.dino.bottomMiddle.y) ||
           this.bottomDinoHit(this.dino.bottomRight.x,this.dino.bottomRight.y);
  }
